        ...
        <Collapsible defaultOpen={isActive} className="group/collapsible">
          <CollapsibleTrigger asChild>
            <SidebarMenuButton tooltip={item.title}>
              {item.icon && <item.icon size="20" variant={isActive ? "Bold" : "Bulk"} className={cn(isActive ? "text-primary dark:text-primary":"text-slate-500 dark:text-slate-200")}/>}
        ...
        <SidebarMenuButton asChild tooltip={item.title}>
          <Link
            ...
            className={cn(
              ...
              isActive && "font-bold bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary"
            )}
          >
            {item.icon && <item.icon size="20" variant={isActive ? "Bold" : "Bulk"} className={cn(isActive ? "text-primary dark:text-primary":"text-slate-500 dark:text-slate-200")}/>}
            <span className="flex items-center gap-2">
